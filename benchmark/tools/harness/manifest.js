...
// Load and validate a hook manifest (benchmark-hook-format). A relative `cwd`
// (or an absent one) resolves against the manifest file's own directory, so a
// manifest can ship inside an implementation's repo and reference its worker
// script relatively.
